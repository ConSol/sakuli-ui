...
test('invalid login', function (t) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, loginPage.login("invalid", "invalid")];
            case 1:
                _a.sent();
                return [4 /*yield*/, t.expect(appShell.toasts.textContent).contains("login failed")];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
test('valid login', function (t) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, loginPage.login("admin", "sakuli123")];
            case 1:
                _a.sent();
